    ...
    <footer className="bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white">Sneakeralot Retail</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            <h3 className="text-sm font-bold mb-4">ABOUT SNEAKERALOT</h3>
            <ul className="space-y-2 text-gray-400">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-gray-400 text-sm">
          <p>&copy; 2024 Sneakeralot, Inc. All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
